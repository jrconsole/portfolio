    ...
    <div className="content tech">
      ...
      <main>
        <section>
          ...
          <ul>
            <li>
              <img title="HTML" src="https://russ-riser-portfolio.s3-us-west-1.amazonaws.com/html.png" alt="HTML logo" />
              HTML
            </li>
            <li>
              <img title="CSS" src="https://russ-riser-portfolio.s3-us-west-1.amazonaws.com/css.png" alt="CSS logo" />
              CSS
            </li>
            <li>
              <img title= "Javascript" src="https://russ-riser-portfolio.s3-us-west-1.amazonaws.com/javascript.png" alt="Javascript logo" /> 
              Javascript
            </li>
            <li>
        ...
        <section>
          ...
          <ul>
            <li>
              <img title="GitLab CI/CD" src="https://russ-riser-portfolio.s3-us-west-1.amazonaws.com/gitLab.png" alt="GitLab logo" /> 
              GitLab CI/CD Pipelines
            </li>
            <li>
              <img title="MySQL" src="https://russ-riser-portfolio.s3-us-west-1.amazonaws.com/mysql.png" alt="MySQL logo" /> 
              MySQL
            </li>
            <li>
              <img title="Spring" src="https://russ-riser-portfolio.s3-us-west-1.amazonaws.com/spring.png" alt="Spring logo" /> 
              Java Spring
            </li>
          </ul>
        </section>
